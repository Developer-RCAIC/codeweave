...
import { Code2, Plus, Trash2, Eye, Calendar, ArrowLeft, Globe, Palette, Zap, Search } from "lucide-react";
...
export default function Dashboard({ onBackToLanding, onNewProject, onOpenProject }: DashboardProps) {
  ...
  const loadProjects = async (userId: string) => {
    try {
      const projectList = await projectService.getUserProjects(userId);
